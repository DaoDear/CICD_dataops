...
table_spec = (
    'vmcluster-437503:'
    'daodear_workshop2.daodear_dfsqltable_sales'
)
...
pipeline_args = [
    '--project=vmcluster-437503',  # Change to your GCP project ID
    '--runner=DataflowRunner',
    '--region=us-central1',  # Adjust as per your GCP region
    '--staging_location=gs://daodear_workshop2/temp/staging/',  # Change to your bucket path
    '--temp_location=gs://daodear_workshop2/temp',  # Change to your bucket path
    '--streaming',
...
(p 
 | 'Read from PubSub' >> beam.io.ReadFromPubSub(
     topic="projects/vmcluster-437503/topics/daodear-transactions"  # Change to your PubSub topic
 )
